-- spending_events sample data — Project Trace
-- 25 realistic Baltimore city expenditure records across CSAs and fiscal years 2021–2024.
-- Load via: supabase/migrations/003_spending_seed.sql
